...
public class AnimationSlider extends RangedSliderWidget implements ISpecialWidget {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blit(net.minecraft.client.renderer.RenderType::guiTextured, ROULETTE_TEXTURE, getX(), getY(), 0, textureBaseY() + 24, this.width, this.height, 200, 15);
        guiGraphics.blit(net.minecraft.client.renderer.RenderType::guiTextured, ROULETTE_TEXTURE, getX() + ((int) (this.value * (this.width - 8))), getY(), 0, handleTextureBaseY() + 24, 8, this.height, 200, 15);
